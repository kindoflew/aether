...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "aether-logo.png", "size": 7147, "type": "image/png" }, { "file": "aether-logo.svg", "size": 12318, "type": "image/svg+xml" }, { "file": "robots.txt", "size": 67, "type": "text/plain" }],
...
var css$1 = {
  code: "main.svelte-1pzzcnv{flex:1;display:flex;flex-direction:column;justify-content:center;align-items:center;padding:1rem;width:100%;max-width:1024px;margin:0 auto;box-sizing:border-box}",
  map: `{"version":3,"file":"__layout.svelte","sources":["__layout.svelte"],"sourcesContent":["<script>\\n  import 'normalize.css';\\n  import '../app.css';\\n<\/script>\\n\\n<main>\\n  <slot />\\n</main>\\n\\n<style>\\n  main {\\n    flex: 1;\\n    display: flex;\\n    flex-direction: column;\\n    justify-content: center;\\n    align-items: center;\\n    padding: 1rem;\\n    width: 100%;\\n    max-width: 1024px;\\n    margin: 0 auto;\\n    box-sizing: border-box;\\n  }</style>\\n"],"names":[],"mappings":"AAUE,IAAI,eAAC,CAAC,AACJ,IAAI,CAAE,CAAC,CACP,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,MAAM,CACjB,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,UAAU,CAAE,UAAU,AACxB,CAAC"}`
};
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `<main class="${"svelte-1pzzcnv"}">${slots.default ? slots.default({}) : ``}
</main>`;
});
